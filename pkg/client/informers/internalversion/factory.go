...
import (
	...
	v1alpha1 "github.com/souravbiswassanto/crd/pkg/client/informers/internalversion/v1alpha1"
...
type SharedInformerFactory interface {
	...
	Makecrd() v1alpha1.Interface
}

func (f *sharedInformerFactory) Makecrd() v1alpha1.Interface {
