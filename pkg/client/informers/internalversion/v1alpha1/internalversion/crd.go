...
import (
	...
	internalinterfaces "github.com/souravbiswassanto/crd/pkg/client/informers/internalversion/internalinterfaces"
	internalversion "github.com/souravbiswassanto/crd/pkg/client/listers/v1alpha1/internalversion"
...
type CrdInformer interface {
	...
	Lister() internalversion.CrdLister
}
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options v1.ListOptions) (runtime.Object, error) {
				...
				return client.Makecrd().Crds(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options v1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.Makecrd().Crds(namespace).Watch(context.TODO(), options)
			},
		},
		&v1alpha1.Crd{},
		resyncPeriod,
...
func (f *crdInformer) defaultInformer(client internalclientset.Interface, resyncPeriod time.Duration) cache.SharedIndexInformer {
...
func (f *crdInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&v1alpha1.Crd{}, f.defaultInformer)
}

func (f *crdInformer) Lister() internalversion.CrdLister {
	return internalversion.NewCrdLister(f.Informer().GetIndexer())
}
