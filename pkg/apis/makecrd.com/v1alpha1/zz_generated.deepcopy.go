...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *CredStatus) DeepCopyInto(out *CredStatus) {
	*out = *in
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new CredStatus.
func (in *CredStatus) DeepCopy() *CredStatus {
	if in == nil {
		return nil
	}
	out := new(CredStatus)
