...
import (
	"flag"
	"fmt"
	"github.com/souravbiswassanto/crd/controller"
	clientset "github.com/souravbiswassanto/crd/pkg/client/clientset/versioned"
	informers "github.com/souravbiswassanto/crd/pkg/client/informers/externalversions"
...
func main() {
	...
	ctrl := controller.NewController(kubeClient, exampleClient,
		...
		exampleInformationFactory.Makecrd().V1alpha1().Crds())
